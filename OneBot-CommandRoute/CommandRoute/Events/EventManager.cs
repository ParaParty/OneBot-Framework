...
namespace OneBot.CommandRoute.Events
{
    public class EventManager
    {
        ...
        public void Fire(IServiceScope scope, BaseSoraEventArgs eventArgs)
        {
            ...
            else if (eventArgs is PrivateMessageEventArgs) { Fire<PrivateMessageEventArgs>(scope, eventArgs, OnPrivateMessage?.GetInvocationList()); }
            else if (eventArgs is AddGroupRequestEventArgs) { Fire<AddGroupRequestEventArgs>(scope, eventArgs, OnGroupRequest?.GetInvocationList()); }
            else if (eventArgs is FriendRequestEventArgs) { Fire<FriendRequestEventArgs>(scope, eventArgs, OnFriendRequest?.GetInvocationList()); }
            else if (eventArgs is FileUploadEventArgs) { Fire<FileUploadEventArgs>(scope, eventArgs, OnFileUpload?.GetInvocationList()); }
            else if (eventArgs is GroupAdminChangeEventArgs) { Fire<GroupAdminChangeEventArgs>(scope, eventArgs, OnGroupAdminChange?.GetInvocationList()); }
            else if (eventArgs is GroupMemberChangeEventArgs) { Fire<GroupMemberChangeEventArgs>(scope, eventArgs, OnGroupMemberChange?.GetInvocationList()); }
            else if (eventArgs is GroupMuteEventArgs) { Fire<GroupMuteEventArgs>(scope, eventArgs, OnGroupMemberMute?.GetInvocationList()); }
            else if (eventArgs is FriendAddEventArgs) { Fire<FriendAddEventArgs>(scope, eventArgs, OnFriendAdd?.GetInvocationList()); }
            else if (eventArgs is GroupRecallEventArgs) { Fire<GroupRecallEventArgs>(scope, eventArgs, OnGroupRecall?.GetInvocationList()); }
            else if (eventArgs is FriendRecallEventArgs) { Fire<FriendRecallEventArgs>(scope, eventArgs, OnFriendRecall?.GetInvocationList()); }
            else if (eventArgs is GroupCardUpdateEventArgs) { Fire<GroupCardUpdateEventArgs>(scope, eventArgs, OnGroupCardUpdate?.GetInvocationList()); }
            else if (eventArgs is GroupPokeEventArgs) { Fire<GroupPokeEventArgs>(scope, eventArgs, OnGroupPoke?.GetInvocationList()); }
            else if (eventArgs is LuckyKingEventArgs) { Fire<LuckyKingEventArgs>(scope, eventArgs, OnLuckyKingEvent?.GetInvocationList()); }
